    ...
    <main>
      ...
      >
        <div className="sm:flex sm:justify-center sm:flex-wrap sm:gap-[12%] sm:mr-[7%]">
          <Particle />
          <div
            className="text-[1.9rem] sm:text-[2.6rem] pl-[rem] pt-[12%] mb-[5%]"
            style={{
              color: "wheat",
              fontWeight: "bolder",
      ...
      <div className="flex mt-[5%] ml-[11%] gap-[10%] flex-wrap text-slate-50">
        ...
        <div className="my-[2%] sm:my-[0]">
          ...
          >
            ...
            <p className="text-[wheat] font-bold text-[1.3rem] sm:text[1.5rem] px-[1%] sm:px-0 leading-9 sm:leading-10 mb-[2%]">
